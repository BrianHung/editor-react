import { EmojiPicker, EmojiPickerRef, EmojiObject, unifiedToNative, throttleIdleTask } from "react-twemoji-picker"
...
export default function EditorEmojiPicker({editor}: {editor: Editor}): JSX.Element {
